...
accelerate launch --multi_gpu train_splade_ce.py --per_device_batch_size 64 --epoch 1 --docModel naver/splade-cocondenser-ensembledistil --gradient_accum 1 --save_path /projects/bfcj/yzound/checkpoint/splade-cocondenser-ensembledistil-qat/